...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { beer_type: @beer.beer_type, brewery: @beer.brewery, description: @beer.description, label_url: @beer.label_url, name: @beer.name }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { beer_type: @beer.beer_type, brewery: @beer.brewery, description: @beer.description, label_url: @beer.label_url, name: @beer.name }
    assert_redirected_to beer_path(assigns(:beer))
  end
